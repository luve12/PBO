...
public Pekerja(String nama, String NIK, boolean
jenisKelamin, boolean menikah, int jamKerja, int
hariKerja, String NIP) {
...
return (getHariKerja() * getJamKerja() *
getGaji());
}
public double getBonuss(){
double bonuslembur = ((getHariKerja() / 7) * 7
+ (getHariKerja() % 7)) * (getJamKerja() - 7) * 5;
double bonuslibur = ((getHariKerja() / 7) * 2 +
getHariKerja() * 20);
if (getJamKerja() <= 7 ){
return bonuslibur;
} else {
